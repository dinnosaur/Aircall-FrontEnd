...
exports.shouldForwardProp = exports.makeButtonVariant = exports.makeButtonTypography = exports.makeButtonSize = exports.makeButtonShadow = void 0;
 ...
 */
var makeButtonVariant = function makeButtonVariant(_ref) {
  ...
  var getBackgroundColor = function getBackgroundColor(color) {
    return mode !== _Button.ButtonMode.FILL ? 'transparent' : color;
  };

  var getTextColor = function getTextColor(color, defaultTextColor) {
    return mode !== _Button.ButtonMode.FILL ? color : defaultTextColor;
  };

  var getBorderColor = function getBorderColor(color) {
    return mode === _Button.ButtonMode.LINK ? 'transparent' : color;
  };
  ...
  var buttonColorFn = variant === _Button.ButtonVariant.GHOST || variant === _Button.ButtonVariant.DARK_GHOST ? makeGhostButtonColor : makeButtonColor;
  return buttonColorFn(paletteColor, textColor);
};

exports.makeButtonVariant = makeButtonVariant;

var makeButtonShadow = function makeButtonShadow(_ref2) {
  ...
  if (disabled) {
    return (0, _styledComponents.css)(["box-shadow:", ";"], theme.shadows[5]);
  }

  return (0, _styledComponents.css)(["box-shadow:", ";:hover{box-shadow:", ";}:active{box-shadow:", ";}:focus{box-shadow:", ";}"], theme.shadows[5], theme.shadows[6], theme.shadows[1], theme.shadows[5]);
};

exports.makeButtonShadow = makeButtonShadow;

var makeButtonTypography = function makeButtonTypography(_ref3) {
  var mode = _ref3.mode,
      disabled = _ref3.disabled,
      theme = _ref3.theme;

  if (mode === _Button.ButtonMode.LINK) {
    return (0, _styledComponents.css)(["", " ", ""], theme.typography.variants.body, disabled ? undefined : (0, _styledComponents.css)([":hover,:active,:focus{text-decoration:underline;}"]));
  }

  return (0, _styledComponents.css)(["", ":hover,:active,:focus{text-decoration:none;}"], theme.typography.variants.subheading);
};

exports.makeButtonTypography = makeButtonTypography;

var makeButtonSize = function makeButtonSize(_ref4) {
  var mode = _ref4.mode,
...
exports.makeButtonSize = makeButtonSize;
