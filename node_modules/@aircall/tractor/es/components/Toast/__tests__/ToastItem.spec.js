...
describe('ToastItem', function () {
  it('should render without icon and action', function () {
    ...
    var _render = render( /*#__PURE__*/React.createElement(ToastItem, {
      dismissIn: 3000,
      variant: "instructive",
      onDismiss: onDismiss,
      message: "message"
  ...
  it('should render without action', function () {
    ...
    var _render2 = render( /*#__PURE__*/React.createElement(ToastItem, {
      icon: /*#__PURE__*/React.createElement("h1", null, "hello"),
      dismissIn: 3000,
      variant: "instructive",
      onDismiss: onDismiss,
      message: "message"
  ...
  it('should render without close button', function () {
    ...
    var _render3 = render( /*#__PURE__*/React.createElement(ToastItem, {
      dismissIn: 3000,
      variant: "instructive",
      onDismiss: onDismiss,
      message: "message",
  ...
  it('should trigger the onAction', function () {
    ...
    var _render4 = render( /*#__PURE__*/React.createElement(ToastItem, {
      icon: /*#__PURE__*/React.createElement("h1", null, "hello"),
      dismissIn: 3000,
      variant: "instructive",
      onDismiss: onDismiss,
  ...
  it('should trigger onDismiss', function () {
    ...
    var _render5 = render( /*#__PURE__*/React.createElement(ToastItem, {
      icon: /*#__PURE__*/React.createElement("h1", null, "hello"),
      dismissIn: 3000,
      variant: "instructive",
      onDismiss: onDismiss,
  ...
  it('should trigger the onClick', function () {
    ...
    var _render6 = render( /*#__PURE__*/React.createElement(ToastItem, {
      icon: /*#__PURE__*/React.createElement("h1", null, "hello"),
      dismissIn: 3000,
      variant: "instructive",
      onDismiss: onDismiss,
    ...
    fireEvent.click(bodyToast);
    expect(onClick).toHaveBeenCalledWith(onDismiss);
  });
  it('should render the appropriate icon', function () {
    var onDismiss = jest.fn();

    var _render7 = render( /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ToastItem, {
      icon: true,
      variant: "primary",
      onDismiss: onDismiss,
      message: "message"
